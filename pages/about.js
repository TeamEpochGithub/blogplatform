...
<>
    ...
    <div className="bg-transparent text-gray-500 opacity-80 p-0 ml-10 mr-10  lg:p-6 pb-12 mb-4">
      ...
      <div className="ml-10 mr-10 mb-6 text-justify">We want to pave an accessible path forward into what we 
        ...
        <div className="ml-4 mr-6 mb-6 text-justify">Team Epoch competes simultaneously in multiple competitions with different 
         ...
         <div className="ml-4 mr-6 mb-8  text-justify">By enabling students with various backgrounds to compete 
        ...
        <div className="ml-4 mr-6 mb-6 text-justify">This is a real-life problem for which most of the time a guideline for the solution already exists, called the 'baseline'.
        ...
        Team Epoch aims to find new solutions for these competitions by combining already existing methods.</div>
         <div className="ml-4 mr-6 mb-6 text-justify">Which competitions we do depends on different aspects like the topic, 
