...
<>
    ...
    <div className="bg-white shadow-lg shadow-stone-500/60 rounded-lg p-0 ml-10 mr-10  lg:p-6 pb-12 mb-8">
      ...
      <div className="ml-10 mr-10 mb-6 text-justify text-black">We want to pave an accessible path forward into what we 
        ...
        <div class="bg-white shadow-lg shadow-stone-500/60 rounded-lg aspect-w-16 aspect-h-9 mb-10 scale-90">
        <iframe width="638" 
                height="478" 
